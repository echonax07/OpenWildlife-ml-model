...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root='',
        metainfo=metainfo,
        ann_file='/home/m32patel/projects/rrg-dclausi/wildlife/datasets/Eider_duck_labelstudio-export/real_sparse_dense.json',
        data_prefix=dict(img=''),
        filter_cfg=dict(filter_empty_gt=False, min_size=32),
        pipeline=train_pipeline,
...
val_evaluator = dict(
    type='CocoMetric',
    ann_file='/home/m32patel/scratch/animal_patches/eider_duck_patches/train/train_slice_filtered.json_coco.json',
    metric='bbox',
    format_only=False,
