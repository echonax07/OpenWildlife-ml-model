...
data_root = '/home/m32patel/projects/rrg-dclausi/wildlife/datasets/NOAA_sea_lion_blackout'
...
model = dict(sliding_window_inference=dict(enable=True, patch_size=patch_size[0], batch_size=1,
                                           patch_overlap_ratio=patch_overlap_ratio, merge_nms_type='nms',  slice_batch_size=36, merge_iou_thr=merge_iou_thr),
...
val_evaluator = dict(ann_file=data_root + '/' + ann_file,
                     outfile_prefix=f'./work_dir_grounding_dino/{{fileBasenameNoExtension}}/prediction_mm_grounding_dino_viz_caption')
test_evaluator = val_evaluator
pickle_file = f'./work_dir_grounding_dino/{{fileBasenameNoExtension}}/prediction_mm_grounding_dino_viz_caption'
