...
data_root = '/home/m32patel/projects/rrg-dclausi/wildlife/datasets/Aerial-livestock-dataset/'
train_ann_file= '/home/m32patel/scratch/animal_patches/Aerial-livestock-dataset/train/train.json'
val_ann_file = 'test/test.json'
test_ann_file = 'test/test.json'
...
merge_iou_thr = 0.5
class_name = ('yak', 'sheep')
num_classes = len(class_name)
metainfo = dict(classes=class_name, palette=[(220, 20, 60), (20, 220, 20)])
...
val_evaluator = dict(ann_file= data_root + '/' + val_ann_file,
                     outfile_prefix=f'./work_dir_grounding_dino/finetune_no_caption_new_split/{{fileBasenameNoExtension}}/prediction_mm_grounding_dino_finetune_val')
