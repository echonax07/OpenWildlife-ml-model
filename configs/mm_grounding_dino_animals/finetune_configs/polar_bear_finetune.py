...
data_root = ''
train_ann_file= '/lustre07/scratch/m32patel/animal_patches/polar_bear/train_5_1024_0.json'
# val_ann_file = 'val_2017.json'
test_ann_file = '/home/m32patel/projects/rrg-dclausi/wildlife/datasets/polar_bear_annotated/test_15.json'
...
train_dataloader = dict(
    dataset=dict(
        ...
        # batch_size=4,
        type='CocoDataset',
        data_root='/lustre07/scratch/m32patel/animal_patches/polar_bear',
        metainfo=metainfo,
        return_classes=True,
        pipeline=train_pipeline,
        filter_cfg=dict(filter_empty_gt=False, min_size=32),
        ann_file=train_ann_file,
        data_prefix=dict(img='train_5_images_1024_0')))
...
val_dataloader = dict(
    dataset=dict(
        ...
        ann_file='/home/m32patel/projects/rrg-dclausi/wildlife/datasets/polar_bear_annotated/test_15.json',
...
val_evaluator = dict(ann_file='/home/m32patel/projects/rrg-dclausi/wildlife/datasets/polar_bear_annotated' + '/test_15.json')
test_evaluator = dict(ann_file='/home/m32patel/projects/rrg-dclausi/wildlife/datasets/polar_bear_annotated' + '/test_15.json')
