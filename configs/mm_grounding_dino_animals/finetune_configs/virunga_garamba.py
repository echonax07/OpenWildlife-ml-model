...
train_dataloader = dict(
    dataset=dict(
        ...
        ann_file='groundtruth/json/big_size/train_big_size_A_B_E_K_WH_WB.json',
...
val_evaluator = dict(ann_file=data_root + '/' + 'groundtruth/json/big_size/test_big_size_A_B_E_K_WH_WB.json')
...
val_evaluator = dict(ann_file=data_root + '/' + ann_file,
                     outfile_prefix=f'./work_dir_grounding_dino/finetune/{{fileBasenameNoExtension}}/prediction_mm_grounding_dino')
test_evaluator = val_evaluator
pickle_file = f'./work_dir_grounding_dino/finetune/{{fileBasenameNoExtension}}/prediction_mm_grounding_dino'

work_dir='work_dir_grounding_dino/finetune/{{fileBasenameNoExtension}}'
load_from = '/home/m32patel/projects/def-dclausi/whale/mmwhale2/work_dir_grounding_dino/grouding_dino_swin-t_finetune_all/epoch_20.pth'  # noqa