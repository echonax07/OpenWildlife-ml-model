...
lang_model_name = 'checkpoints/laion/CLIP-ViT-B-32-laion2B-s34B-b79K'
...
model = dict(language_model=dict(
    ...
    num_layers_of_embedded=1,  # Average last 1 layers
