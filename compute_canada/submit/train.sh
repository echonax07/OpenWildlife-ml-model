...
srun --ntasks=1 --gres=gpu:1 --kill-on-bad-exit=1 --cpus-per-task=12 --nodes=1 python tools/train.py $1 --launcher slurm --cfg-options env_cfg.dist_cfg.port=${random_number}
