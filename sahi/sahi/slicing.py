...
def slice_image(
    ...
    verbose: bool = False,
    save_only_positive_slices: bool = False,  # New parameter to control saving only positive slices
) -> SliceImageResult:
    ...
    Args:
        ...
        verbose (bool, optional): Switch to print relevant values to screen.
            Default 'False'.
        save_only_positive_slices (bool, optional): If True, save only slices that contain annotations.
            Default 'False'.
    ...
    def _export_single_slice(image: np.ndarray, output_dir: str, slice_file_name: str):
        ...
        # export sliced image
        # quality is removed due to discussions/973,981, pull/956
    ...
    for slice_bbox in slice_bboxes:
        ...
        # Skip the slice if it doesn't contain any annotations and save_only_positive_slices is True
        if save_only_positive_slices and not has_annotations:
            continue
